# Project : Implementing Vector Search with LlamaIndex
...
[get an API key](https://platform.openai.com/account/api-keys) and add to `.env` file

OPENAI_API_KEY=sk-brHeh...A39v5iXsM2

or export using the terminal
